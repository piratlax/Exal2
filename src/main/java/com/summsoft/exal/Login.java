...
public class Login extends javax.swing.JFrame {
    ...
    private void Styles(){
        btnAcceder.putClientProperty("Button.arc", 999);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AUTOBUSES EXAL");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/portada.png"))); // NOI18N
       ...
       DaoUsuario dao=new ImplUsuario();
        try {
            ...
            if (acceso){
              ...
              JOptionPane.showMessageDialog(null, "Usuario no reconocido", "Advertencia", JOptionPane.WARNING_MESSAGE);
              txtPassword.setText("");
            }
